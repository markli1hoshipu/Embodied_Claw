"""Claude Agent SDK backend for eval_domino agents.
...
Long tools: run_pending_shards blocks ~25 min — MCP_TOOL_TIMEOUT is raised accordingly.
"""
...
class SDKAgent:
    ...
    def run_node(self, node_name: str, prompt_str: str) -> dict:
        ...
        deadline = time.time() + float(os.environ.get("EVAL_SDK_LIMIT_WAIT_H", "8")) * 3600
        while True:
            try:
